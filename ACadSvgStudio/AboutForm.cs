...
namespace ACadSvgStudio {
	...
	public partial class AboutForm : Form {
		...
		public AboutForm()
		{
			...
			addItem("ACadSvg", "0.1.0", "C# library to convert AutoCAD drawings from DWG to SVG. AutoCAD files are read using ACadSharp.", "https://github.com/nanoLogika/ACadSvg", "LGPL-3.0");
			addItem("SvgElements", "0.1.0", "C# library providing an object model to create SVG/XML elements and attributes.", "https://github.com/nanoLogika/SvgElements", "LGPL-3.0");
